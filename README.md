...
It uses the framework of tabs within a conventional spreadsheet to emulate storing the multi-dimensional data required.  It can do some basic things, and I'd love to see it grow...but the real goal is for an entity with much more muscle to do this right - from the ground up.
